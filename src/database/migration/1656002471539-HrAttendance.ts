...
export class HrAttendance1656002471539 implements MigrationInterface {
    name = 'HrAttendance1656002471539'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "attendance" ADD "device_id" integer`);

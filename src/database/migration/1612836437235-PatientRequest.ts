...
export class PatientRequest1612836437235 implements MigrationInterface {
    name = 'PatientRequest1612836437235'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "filledBy" character varying(300)`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "filled_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "cancelled" smallint NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "cancelledBy" character varying(300)`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "cancelled_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "received" smallint NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "receivedBy" character varying(300)`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "received_at" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "filled"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "filled" smallint NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "patient_requests"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "filled"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "filled" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`COMMENT ON COLUMN "patient_request_items"."updated_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "patient_request_items"."createdAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "stocks"."updated_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "stocks"."createdAt" IS NULL`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "patient_next_of_kins"."updated_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "patient_next_of_kins"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "received_at"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "receivedBy"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "received"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "cancelled_at"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "cancelledBy"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "cancelled"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "filled_at"`);

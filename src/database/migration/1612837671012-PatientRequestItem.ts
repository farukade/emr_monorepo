...
export class PatientRequestItem1612837671012 implements MigrationInterface {
    name = 'PatientRequestItem1612837671012'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "approved" smallint NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "approved"`);
    }

...
export class UpdatedTable1597844565290 implements MigrationInterface {
    name = 'UpdatedTable1597844565290'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "diagnosis" DROP COLUMN "codeStatus"`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "diagnosis" ADD "codeStatus" character varying(300) NOT NULL`, undefined);
    }

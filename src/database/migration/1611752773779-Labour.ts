...
export class Labour1611752773779 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "labour_measurements" ADD CONSTRAINT "FK_fde2037d9915be7816cfce60295" FOREIGN KEY ("enrollementId") REFERENCES "labour_enrollemnts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

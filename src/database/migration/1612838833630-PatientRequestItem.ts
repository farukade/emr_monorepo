...
export class PatientRequestItem1612838833630 implements MigrationInterface {
    name = 'PatientRequestItem1612838833630'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "filled_at" character varying`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "cancelled_at"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "cancelled_at" character varying`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "received_at"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "received_at" character varying`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "approved_at"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "approved_at" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "patient_requests"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "approved_at"`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "approved_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "received_at"`);

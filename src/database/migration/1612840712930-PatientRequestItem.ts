...
export class PatientRequestItem1612840712930 implements MigrationInterface {
    name = 'PatientRequestItem1612840712930'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "patient_request_items" ADD "note" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "patient_next_of_kins"."updated_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "patient_next_of_kins"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "patient_request_items" DROP COLUMN "note"`);
    }

...
export class Immunization1601052696651 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "immunizations" ("id" SERIAL NOT NULL, "name_of_vaccine" character varying NOT NULL, "slug" character varying(30) NOT NULL, "description" character varying NOT NULL, "date_due" character varying NOT NULL, "period" character varying NOT NULL, "date_administered" character varying, "appointment_date" character varying, "updateAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "patient_id" uuid, "staff_id" uuid, "administeredBy" uuid, CONSTRAINT "PK_d6ef20ce9b42402adbbd1e260fe" PRIMARY KEY ("id"))`, undefined);

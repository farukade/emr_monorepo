import { Controller, Post, Body, Param, Request, Delete, Get, Query, UsePipes, ValidationPipe, Patch, UseGuards } from '@nestjs/common';
...
export class PaymentMethodController {
    ...
    saveMethod(
        @Body() createDto: PaymentMethodDto,
        @Request() req,
    ) {
    ...
    updateMethod(
        @Param('id') id: number,
        @Body() updateDto: PaymentMethodDto,
        @Request() req,
    ) {

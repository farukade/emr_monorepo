...
export class LabTestRepository extends Repository<LabTest> {
    ...
    async saveLabTest(labTestDto: LabTestDto, category: LabTestCategory, createdBy: string, hmo: HmoScheme): Promise<LabTest> {
    ...
    async updateLabTest(labTestDto: LabTestDto, labTest: LabTest, category: LabTestCategory, updatedBy: string, hmo: HmoScheme): Promise<LabTest> {

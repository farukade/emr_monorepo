...
export class ImmunizationService {
	...
	async fetch(id: string): Promise<Immunization[]> {
		return await this.immunizationRepository.createQueryBuilder('i').where('i.patient_id = :id', { id }).leftJoinAndSelect('i.administeredBy', 'staff').orderBy('i.id', 'ASC').getMany();
	}
	...
	async enroll(param, createdBy): Promise<any> {
		...
		try {
			...
			if (patient) {
				const immunizations = await this.immunizationRepository.createQueryBuilder('i').where('i.patient_id = :patient_id', { patient_id }).getMany();
				...
				if (immunizations.length === 0) {
					const vaccines = [
						...
						},
						{
							...
							weeks: [
								{ time: 0, type: 'w', gender: 'all' },
								{ time: 6, type: 'w', gender: 'all' },
								{ time: 10, type: 'w', gender: 'all' },
								{ time: 14, type: 'w', gender: 'all' },
								{ time: 5, type: 'y', gender: 'male' },
							],
						},
						{
							name: 'HBV',
							...
							weeks: [
								{ time: 0, type: 'w', gender: 'all' },
								{ time: 18, type: 'M', gender: 'male' },
								{ time: 2, type: 'y', gender: 'male' },
							],
						},
						{
						...
						},
						{
							...
							weeks: [
								{ time: 6, type: 'M', gender: 'all' },
								{ time: 12, type: 'M', gender: 'all' },
							],
						},
						{
							name: 'Measles',
						...
						},
						{
							...
							weeks: [
								{ time: 9, type: 'M', gender: 'all' },
								{ time: 10, type: 'y', gender: 'all' },
							],
						},
						{
							...
							weeks: [
								{ time: 10, type: 'w', gender: 'male' },
								{ time: 18, type: 'w', gender: 'male' },
								{ time: 9, type: 'M', gender: 'female' },
								{ time: 12, type: 'M', gender: 'all' },
							],
						},
						{
						...
						},
						{
							...
							weeks: [
								{ time: 18, type: 'M', gender: 'all' },
								{ time: 2, type: 'y', gender: 'all' },
							],
						},
						{
							name: 'Typhoid Fever',
						...
						},
						{
							...
							weeks: [
								{ time: 9, type: 'y', gender: 'female' },
								{ time: 9, type: 'y', extra: 1, gender: 'female' },
								{ time: 9, type: 'y', gender: 'female', extra: 6 },
							],
						},
					];

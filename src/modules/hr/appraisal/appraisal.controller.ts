...
export class AppraisalController {
  ...
  @Patch(':id/update')
  updateAppraisal(@Param() id: string, @Body() updateAppraisalDto: UpdateAppraisalDto) {
  ...
  @Post('save-period')
  @UsePipes(ValidationPipe)
  saveAppraisalPeriod(@Body() createAppriasalPeriodDto: CreateAppriasalPeriodDto) {
    return this.appraisalService.savePerformancePeriod(createAppriasalPeriodDto);
  }

  @Patch('update-period')
  @UsePipes(ValidationPipe)
  updateAppraisalPeriod(@Body() createAppriasalPeriodDto: CreateAppriasalPeriodDto) {
    return this.appraisalService.updatePerformancePeriod(createAppriasalPeriodDto);
  }

  @Post('update-period-status/:id')
  ...
  getAssessmentReportInfo(@Param('staffId') staffId: string, @Param('periodId') periodId: string) {
  ...
  uploadPerformanceAppraisal(@UploadedFile() file, @Body() createAppraisalDto: CreateAppriasalDto) {
